...
class CommentViewController: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate {
  ...
  func pickerView(pickerView: UIPickerView, viewForRow row: Int, forComponent component: Int, reusingView view: UIView!) -> UIView {
    ...
    switch component{
    case 0:
      pickerViewLabel.text = firstArray[row]
    case 1:
      pickerViewLabel.text = secondArray[row]
    case 2:
      pickerViewLabel.text = thirdArray[row]
    case 3:
      pickerViewLabel.text = fourthArray[row]
    case 4:
      pickerViewLabel.text = fifthArray[row]
    default:
      println("Ok")
    }
    
    pickerViewLabel.font = UIFont(name: "Heavyweight", size: 18)
